...
function FollowOnCredit()
{
  ...
  $merchantInformation = new CyberSource\Model\V2paymentsProcessingInformation($merchantInformationArr);

  $shippingDetailsArr = [
    "shipFromPostalCode" => "47404"
  ];
  $shippingDetails = new CyberSource\Model\V2paymentsOrderInformationAmountDetails($shippingDetailsArr);
  $invoiceDetailsArr = [
    "purchaseOrderDate" => "20111231",
    "purchaseOrderNumber" => "CREDIT US"
  ];
  $invoiceDetails = new CyberSource\Model\V2paymentsOrderInformationAmountDetails($invoiceDetailsArr);
