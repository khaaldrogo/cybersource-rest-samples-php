...
function visa()
{
 ...
 $billtoArr = [
  ...
  $invoiceDetailsInfo = new CyberSource\Model\V2paymentsOrderInformationInvoiceDetails($invoiceDetailsArr);
  $orderInfoArry = [
    'amountDetails' => $amountDetInfo,
    'billTo' => $billto,
	'invoiceDetails' => $invoiceDetailsInfo
  ];
